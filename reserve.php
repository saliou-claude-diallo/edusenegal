...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid sticky-top px-0">
            <div class="container-fluid topbar bg-success d-none d-lg-block">
                <div class="container px-0">
                    <div class="topbar-top d-flex justify-content-between flex-lg-wrap">
                        <div class="top-info flex-grow-0">
                            <span class="rounded-circle btn-sm-square bg-warning me-2">
                            ...
                            <div class="overflow-hidden" style="width: 735px;">
                                <div id="note" class="ps-2">
                                    ...
                                    <a href="#"><p class="text-warning mb-0 link-hover">Bienvenue Dans Notre Site SENEGAL EDU</p></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container px-0">
                    <nav class="navbar navbar-light navbar-expand-xl">
                        <a href="index.html" class="navbar-brand mt-3">
                            <p class="text-success display-6 mb-3" style="line-height: 0;">Senegal</p>
                            <small class="text-body fw-normal" style="letter-spacing: 12px;"><span class="text-danger">EDU</span></small>
                        </a>
                        ...
                        <div class="collapse navbar-collapse bg-light py-3" id="navbarCollapse">
                            <div class="navbar-nav mx-auto border-top">
                                <a href="index.html" class="nav-item nav-link active"><span class="text-success">Home</span></a>
                                <a href="detail-page.html" class="nav-item nav-link"><span class="text-success">Detail  Page</span></a>
                                <a href="404.html" class="nav-item nav-link"><span class="text-success">404 Page</span></a>
                                <div class="nav-item dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><span class="text-success">Dropdown</span></a>
                                ...
                                <a href="contact.html" class="nav-item nav-link"><span class="text-success">Contact Us</span></a>
                            </div>
                            <div class="d-flex flex-nowrap border-top pt-3 pt-xl-0">
                                <div class="d-flex">
                                    <img src="assets/img/weather-icon.png" class="img-fluid w-100 me-2" alt="">
                                    <div class="d-flex align-items-center">
                                        <strong class="fs-4 text-danger">31°C</strong>
                                        <div class="d-flex flex-column ms-2" style="width: 150px;">
                                            <span class="text-danger">DAKAR,</span>
                                            <small class="text-danger">MARD. 10 DECEMBRE 2024</small>
                                        </div>
                                    </div>
                                </div>
                                <button class="btn-search btn border border-danger btn-md-square rounded-circle bg-white my-auto" data-bs-toggle="modal" data-bs-target="#searchModal"><i class="fas fa-search text-danger"></i></button>
                            </div>
                        </div>
                    </nav>
                </div>
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="position-relative banner-2">
                                                    <img src="assts/img/banner-2.jpg" class="img-fluid w-100 rounded" alt="">
                        ...
                        <div class="footer-item-2">
                                ...
                                <a href="#">
                                    <div class="d-flex align-items-center">
                                        <div class="rounded-circle border border-2 border-primary overflow-hidden">
                                            <img src="assets/img/footer-1.jpg" class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                        </div>
                            ...
                            <div class="d-flex flex-column">
                                <a href="#">
                                    <div class="d-flex align-items-center">
                                        <div class="rounded-circle border border-2 border-primary overflow-hidden">
                                            <img src="assets/img/footer-2.jpg" class="img-zoominimg-fluid rounded-circle w-100" alt="">
                                        </div>
                                        <div class="d-flex flex-column ps-4">
